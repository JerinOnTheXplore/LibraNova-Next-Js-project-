...
const BlogDetails = () => {
  ...
  if (!currentBlog) return <p className="text-center py-20">Loading...</p>;
     ...
     <section className="max-w-6xl mx-auto px-4 py-36 flex flex-col lg:flex-row gap-8">
      ...
      {/* Back Button */}
        ...
        <div className="flex gap-4 mb-6">
          <img src={currentBlog.images[1]} alt="" className="w-1/2 rounded object-cover" />
          <img src={currentBlog.images[2]} alt="" className="w-1/2 rounded object-cover" />
        </div>
        ...
        {/* Leave a Comment */}
        <form onSubmit={handleComment} className="bg-base-100 p-6 rounded-lg">
