...
export default function BlogList() {
 const router = useRouter();
  ...
  // Load saved page from localStorage (browser-only)
  useEffect(() => {
      ...
      <div className="flex flex-col lg:flex-row gap-8 px-4">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
          {currentBlogs.map((blog) => (
            <div key={blog.id} className="bg-base-300 rounded-xl shadow-lg overflow-hidden">
              <img
                src={blog.images[0]} 
                alt={blog.title}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {blogs.slice(0, 3).map((blog) => (
                <div key={blog.id} className="flex gap-2 bg-base-300 p-2 rounded">
                  <img
                    src={blog.images[0]} 
                    alt={blog.title}
