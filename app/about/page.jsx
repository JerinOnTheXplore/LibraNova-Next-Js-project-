...
/**
 * === INSTRUCTIONS ===
 * Replace the placeholder strings below with your real links / images / text.
 *
 * - profileImage: your personal photo URL (jpg/png)
 * - libraImage: image representing Libra Nova (Unsplash provided, you can change)
 * - project1/project2: update title, description, liveLink, githubLink, image
 * - social: update facebook/linkedin/github URLs
 */
...
const project1 = {
    ...
    image:
        "https://i.ibb.co.com/M59YHbmS/tour.png",
};
...
const project2 = {
    ...
    image:
        "https://i.ibb.co.com/KzRHd0v8/online.png",
};
        ...
        <div className="min-h-screen bg-base-100 text-base-content py-24">
            ...
            <section className="max-w-6xl mx-auto px-6 py-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {/* Project 1 */}
                    <article className="bg-base-300 rounded shadow overflow-hidden">
            ...
            {/* CONTACT / CTA */}
            <section className="py-14 px-6 mt-8 bg-base-200 text-base-content">
